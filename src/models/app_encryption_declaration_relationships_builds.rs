...
pub struct AppEncryptionDeclarationRelationshipsBuilds {
...
impl AppEncryptionDeclarationRelationshipsBuilds {
    pub fn new() -> AppEncryptionDeclarationRelationshipsBuilds {
