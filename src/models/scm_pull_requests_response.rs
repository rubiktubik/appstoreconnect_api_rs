...
pub struct ScmPullRequestsResponse {
    #[serde(rename = "data")]
    pub data: Vec<models::ScmPullRequest>,
...
impl ScmPullRequestsResponse {
    pub fn new(data: Vec<models::ScmPullRequest>, links: models::PagedDocumentLinks) -> ScmPullRequestsResponse {
