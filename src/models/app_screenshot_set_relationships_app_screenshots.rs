...
pub struct AppScreenshotSetRelationshipsAppScreenshots {
    ...
    pub data: Option<Vec<models::AppScreenshotSetRelationshipsAppScreenshotsDataInner>>,
}

impl AppScreenshotSetRelationshipsAppScreenshots {
    pub fn new() -> AppScreenshotSetRelationshipsAppScreenshots {
