...
pub struct BetaAppReviewSubmission {
    ...
    pub attributes: Option<Box<models::BetaAppReviewSubmissionAttributes>>,
...
impl BetaAppReviewSubmission {
    pub fn new(r#type: Type, id: String) -> BetaAppReviewSubmission {
