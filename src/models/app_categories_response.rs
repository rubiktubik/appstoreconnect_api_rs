...
pub struct AppCategoriesResponse {
    ...
    pub included: Option<Vec<models::AppCategory>>,
    #[serde(rename = "links")]
...
impl AppCategoriesResponse {
    pub fn new(data: Vec<models::AppCategory>, links: models::PagedDocumentLinks) -> AppCategoriesResponse {
