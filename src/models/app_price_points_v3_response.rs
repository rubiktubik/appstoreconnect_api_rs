...
pub struct AppPricePointsV3Response {
    #[serde(rename = "data")]
    pub data: Vec<models::AppPricePointV3>,
...
impl AppPricePointsV3Response {
    pub fn new(data: Vec<models::AppPricePointV3>, links: models::PagedDocumentLinks) -> AppPricePointsV3Response {
