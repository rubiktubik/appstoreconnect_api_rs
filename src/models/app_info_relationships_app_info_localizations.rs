...
pub struct AppInfoRelationshipsAppInfoLocalizations {
    ...
    pub data: Option<Vec<models::AppInfoRelationshipsAppInfoLocalizationsDataInner>>,
}

impl AppInfoRelationshipsAppInfoLocalizations {
    pub fn new() -> AppInfoRelationshipsAppInfoLocalizations {
