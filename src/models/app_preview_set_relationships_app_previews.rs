...
pub struct AppPreviewSetRelationshipsAppPreviews {
    ...
    pub data: Option<Vec<models::AppPreviewSetRelationshipsAppPreviewsDataInner>>,
}

impl AppPreviewSetRelationshipsAppPreviews {
    pub fn new() -> AppPreviewSetRelationshipsAppPreviews {
