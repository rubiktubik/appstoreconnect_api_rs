...
pub struct WinBackOfferPricesResponse {
    #[serde(rename = "data")]
    pub data: Vec<models::WinBackOfferPrice>,
...
impl WinBackOfferPricesResponse {
    pub fn new(data: Vec<models::WinBackOfferPrice>, links: models::PagedDocumentLinks) -> WinBackOfferPricesResponse {
