...
pub struct AppStoreVersionAttributes {
    ...
    #[serde(rename = "appVersionState", skip_serializing_if = "Option::is_none")]
    pub app_version_state: Option<models::AppVersionState>,
...
impl AppStoreVersionAttributes {
    pub fn new() -> AppStoreVersionAttributes {
        AppStoreVersionAttributes {
            platform: None,
            version_string: None,
            app_store_state: None,
            app_version_state: None,
            copyright: None,
            review_type: None,
            release_type: None,
