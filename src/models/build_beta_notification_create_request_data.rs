...
pub struct BuildBetaNotificationCreateRequestData {
    #[serde(rename = "type")]
    pub r#type: Type,
...
impl BuildBetaNotificationCreateRequestData {
    pub fn new(r#type: Type, relationships: models::BetaAppReviewSubmissionCreateRequestDataRelationships) -> BuildBetaNotificationCreateRequestData {
