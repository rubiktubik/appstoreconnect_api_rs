...
pub struct ReviewSubmissionRelationshipsItems {
    ...
    pub data: Option<Vec<models::ReviewSubmissionRelationshipsItemsDataInner>>,
}

impl ReviewSubmissionRelationshipsItems {
    pub fn new() -> ReviewSubmissionRelationshipsItems {
