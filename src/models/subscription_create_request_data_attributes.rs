...
pub struct SubscriptionCreateRequestDataAttributes {
    #[serde(rename = "name")]
    pub name: String,
...
impl SubscriptionCreateRequestDataAttributes {
    pub fn new(name: String, product_id: String) -> SubscriptionCreateRequestDataAttributes {
