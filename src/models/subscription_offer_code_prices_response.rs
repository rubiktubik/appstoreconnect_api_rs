...
pub struct SubscriptionOfferCodePricesResponse {
    #[serde(rename = "data")]
    pub data: Vec<models::SubscriptionOfferCodePrice>,
...
impl SubscriptionOfferCodePricesResponse {
    pub fn new(data: Vec<models::SubscriptionOfferCodePrice>, links: models::PagedDocumentLinks) -> SubscriptionOfferCodePricesResponse {
