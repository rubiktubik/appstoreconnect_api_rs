...
pub struct GameCenterLeaderboardUpdateRequestDataAttributes {
    ...
    pub score_range_start: Option<models::Decimal>,
    #[serde(rename = "scoreRangeEnd", skip_serializing_if = "Option::is_none")]
    pub score_range_end: Option<models::Decimal>,
    #[serde(rename = "recurrenceStartDate", skip_serializing_if = "Option::is_none")]
...
impl GameCenterLeaderboardUpdateRequestDataAttributes {
    pub fn new() -> GameCenterLeaderboardUpdateRequestDataAttributes {
