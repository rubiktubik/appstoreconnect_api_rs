...
pub struct AppStoreVersionLocalizationCreateRequestDataAttributes {
...
impl AppStoreVersionLocalizationCreateRequestDataAttributes {
    pub fn new(locale: String) -> AppStoreVersionLocalizationCreateRequestDataAttributes {
